...
8. You're done. Any of the Clerk events you selected will automatically be sent to Tinybird via the [Events API](/ingest/events-api). You can test the integration from the **Testing** tab in the Clerk Webhooks UI. 