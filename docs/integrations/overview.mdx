...
<Cards>
  ...
  - [Tinybird](/docs/integrations/analytics/tinybird)
  - Analyze Clerk events with Tinybird
  - {<svg width="24" height="24" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="500" height="500" fill="url(#paint0_linear_2_11)"/><g clip-path="url(#clip0_2_11)"><path opacity="0.6" d="M437.5 94.6L320.425 62.5L279.25 154.525L437.5 94.6ZM325.525 321.55L218.35 283.225L155.425 437.5L325.525 321.55Z" fill="white"/><path d="M62.5 227.425L325.525 321.55L368.65 120.4L62.5 227.425Z" fill="white"/></g><defs><linearGradient id="paint0_linear_2_11" x1="0" y1="0" x2="495.677" y2="504.249" gradientUnits="userSpaceOnUse"><stop stop-color="#04BAF5"/><stop offset="1" stop-color="#22CD88"/></linearGradient><clipPath id="clip0_2_11"><rect width="375" height="375" fill="white" transform="translate(62.5 62.5)"/></clipPath></defs></svg>}
</Cards>
