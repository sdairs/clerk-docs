...
<Cards>
  ...
  - Send Clerk events to Tinybird to build custom metrics
  - {<svg fill="none" viewBox="0 0 500 500" xmlns="http://www.w3.org/2000/svg"><rect width="500" height="500" fill="url(#a)"/><g clip-path="url(#b)" fill="#fff"><path d="m437.5 94.6-117.08-32.1-41.175 92.025 158.25-59.925zm-111.98 226.95-107.18-38.325-62.925 154.28 170.1-115.95z" opacity=".6"/><path d="m62.5 227.42 263.02 94.125 43.125-201.15-306.15 107.02z"/></g>}
</Cards>
